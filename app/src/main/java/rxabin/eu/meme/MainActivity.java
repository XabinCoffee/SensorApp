...
import rxabin.eu.meme.obj.Ball;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    int[] sounds = {R.raw.fart_01, R.raw.fart_02, R.raw.fart_03, R.raw.fart_04};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout thatBigOlThang = findViewById(R.id.the_whole_fucking_screen);
        randPos = true;
        debug = false;
        ...
        tracer = MediaPlayer.create(this, R.raw.tracer);
        ranger = MediaPlayer.create(this, R.raw.ranger);


        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            Window window = getWindow();
            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            window.setStatusBarColor(getResources().getColor(R.color.degenerate));
            window.setNavigationBarColor(getResources().getColor(R.color.degenerate));
        }
        ...
        thatBigOlThang.addView(ballView);


        numberOfBalls.setText("Balls: " + balls.size());

        thatBigOlThang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                MediaPlayer mp = MediaPlayer.create(MainActivity.this, sounds[rndm]);
                mp.start();
